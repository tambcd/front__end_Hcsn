export  const Resource = {
    ...
    VN_Maximaine:"Phóng to",
    VN_Minimaine:"Thu nhỏ",
    VN_DepartmentValidate : "Dữ liệu đơn vị không có trong danh mục",
    /**lỗi lấy dữ liệu*/ 
    VN_ErroData : "Lỗi lấy dữ liệu",
    /**valide ngày lớn hơn ngày hiện tại*/ 
    VN_DateValidate : "Không lớn hơn ngày hiện tại.",  
    /**Thêm thành công */ 
    ...
    VN_DeleteEmptyLicense : "Vui lòng chọn chứng từ",   
    /**Xóa thất bại */ 
    ...
    /**Xuất khẩu thất bại*/
    VN_ExportErro:"Xuất khẩu thất bại" ,
    /**thêm tài sản */
    VN_Add:"Thêm tài sản",
    /**Sửa tài sản */
